/**
 * Test 111movies encoding v8 - with AES-256-CBC (correct algorithm!)
 * 
 * Deobfuscated findings:
 * - Algorithm: aes-256-cbc (NOT aes-128-cbc)
 * - Key: 32 bytes
 * - IV: 16 bytes
 * - Input encoding: utf8
 * - Output encoding: hex
...
function encodePageData(pageData) {
  // Step 1: AES-256-CBC encrypt (CORRECT ALGORITHM!)
  ...
  // Step 3: Convert to UTF-8 bytes (chars > 127 become multi-byte)
...
async function testEncoding() {
  console.log('=== TESTING 111MOVIES ENCODING V8 (AES-256-CBC) ===\n');
